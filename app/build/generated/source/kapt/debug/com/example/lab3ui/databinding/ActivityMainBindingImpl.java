...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1},
            new int[] {com.example.lab3ui.R.layout.app_bar_main});
    ...
    private ActivityMainBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (com.example.lab3ui.databinding.AppBarMainBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeAppBarMain((com.example.lab3ui.databinding.AppBarMainBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeAppBarMain(com.example.lab3ui.databinding.AppBarMainBinding AppBarMain, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
